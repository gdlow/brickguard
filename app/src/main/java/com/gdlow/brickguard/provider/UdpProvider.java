...
public class UdpProvider extends Provider {
    ...
    public UdpProvider(ParcelFileDescriptor descriptor, BrickGuardVpnService service) {
    ...
    protected void forwardPacket(DatagramPacket outPacket, IpPacket parsedPacket, AbstractDnsServer dnsServer) throws BrickGuardVpnService.VpnNetworkException {
     ...
     * @throws BrickGuardVpnService.VpnNetworkException If some network error occurred
     */
    @Override
    protected void handleDnsRequest(byte[] packetData) throws BrickGuardVpnService.VpnNetworkException {
