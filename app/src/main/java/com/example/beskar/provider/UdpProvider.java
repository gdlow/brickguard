...
public class UdpProvider extends Provider {
    ...
    public UdpProvider(ParcelFileDescriptor descriptor, BeskarVpnService service) {
    ...
    protected void forwardPacket(DatagramPacket outPacket, IpPacket parsedPacket, AbstractDnsServer dnsServer) throws BeskarVpnService.VpnNetworkException {
     ...
     * @throws BeskarVpnService.VpnNetworkException If some network error occurred
     */
    @Override
    protected void handleDnsRequest(byte[] packetData) throws BeskarVpnService.VpnNetworkException {
